...
setup_responses = dbutils.notebook.run("./Utils/Setup-Batch-ELT", 0, {"storage_account_name": storage_account_name, "dataset_container_name": dataset_container_name, "container_name": container_name}).split()
